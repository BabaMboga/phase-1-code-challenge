// We prompt the user to insert the basic salary and benefits 
const basicSalary = prompt("Please enter employee's basic salary:");
const benefits = prompt("Please enter employee's benefits:");

// The gross is calculated from the inputs given by the user.
let gross = basicSalary + benefits;

// This is a function that calculates the NHIF deductions.
function calcNhifDeduction(gross){
    let nhif = 0;
    if(gross <= 5999){
        nhif = 150
    }
...
function calcNssfDeduction(gross){
    nssf = (5/100) * gross;
...
// The user finally gets all the relevant data they need.
